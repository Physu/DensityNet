model = dict(
    ...
    bbox_head=dict(
        ...
        vote_aggregation_cfg=dict(
            ...
            xyz_se_channels=((16, 16, 32), (16, 16, 32), (32, 32, 64)),
            feat_se_channels=((16, 16, 32), (16, 16, 32), (32, 32, 64)),
            se_channels=((4, 1), (32, 16), (32, 16)),
            se_shortcut_channels=((4, 32), (4, 32), (4, 64)),
            norm_cfg=dict(type='BN2d', eps=0.001, momentum=0.1),
            use_xyz=True,
            normalize_xyz=False,
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
optimizer = dict(type='AdamW', lr=0.01, weight_decay=0)
optimizer_config = dict(grad_clip=dict(max_norm=35, norm_type=2))
lr_config = dict(policy='step', warmup=None, step=[56, 64])
total_epochs = 80  #
...
find_unused_parameters = True  # to solve the bug:RuntimeError: Expected to have finished reduction in the prior iteration before starting a new one https://github.com/open-mmlab/mmdetection/issues/2117
# 修改repeat=2
# 多卡训练，batchsize从2调整4，修改为75epoch，lr schedule也对应调整
#
