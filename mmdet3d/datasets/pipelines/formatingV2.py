...
@PIPELINES.register_module()
class DefaultFormatBundle3DV2(DefaultFormatBundle3D):
    ...
    - 添加了point wise mask 信息
    """

    def __init__(self, class_names, with_gt=True, with_label=True):
        super(DefaultFormatBundle3DV2, self).__init__(class_names, with_gt=True, with_label=True)
    ...
    def __call__(self, results):
        ...
        for key in ['voxels', 'coors', 'voxel_centers', 'num_points', 'point_wise_mask']:
