...
class VoteModule(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_out = nn.Conv1d(prev_channels, out_channel, 1)  # 注意这里，如论文中一样，没有relu，bn
    ...
    def get_loss(self, seed_points, vote_points, seed_indices,
        ...
        # :todo torch.gather(input, dim, index, *, sparse_grad=False, out=None) → Tensor
        # gather用法还是相对有点复杂
