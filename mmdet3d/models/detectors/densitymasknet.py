...
class DensityMaskNet(SingleStage3DDetectorV2):
    """3DSSDNet model.
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(DensityMaskNet, self).__init__(
            backbone=backbone,
            bbox_head=bbox_head,
            train_cfg=train_cfg,
            test_cfg=test_cfg,
    ...
    def forward_train(self,
        ...
        loss_inputs = (points, gt_bboxes_3d, gt_labels_3d, point_wise_mask, pts_semantic_mask,
