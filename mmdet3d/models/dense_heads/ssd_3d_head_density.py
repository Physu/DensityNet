...
class SSD3DHeadDensity(VoteHead):
    '''
    注意这里，修改了  _extract_input（）function 这里要注意
    '''
    ...
    def __init__(self,
                 ...
                 corner_loss=None,
                 vote_loss=None):
        super(SSD3DHeadDensity, self).__init__(
            num_classes,
            bbox_coder,
            train_cfg=train_cfg,
            test_cfg=test_cfg,
    ...
    def forward(self, feat_dict, sample_mod):
        ...
        seed_points, seed_features, seed_indices, _, _ = self._extract_input(
            feat_dict)
